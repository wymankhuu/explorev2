      ...
      <div className="bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-6 py-8 sm:py-12">
          <a
            ...
            className="inline-flex items-center gap-1.5 text-sm font-medium text-slate-400 hover:text-white transition-colors mb-5"
          >
            <ArrowLeft size={16} />
            Back to collections
          </a>
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-start gap-4">
              <span className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-white/10">
                <CollectionIcon name={collection.iconName} className="text-white" />
              </span>
              <div>
          ...
          {collection.description && (
            <p className="text-slate-300 leading-relaxed max-w-3xl mt-4 text-[15px]">
              {collection.description}
            </p>
          )}
        </div>

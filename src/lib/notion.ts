...
const COLLECTION_DESCRIPTIONS: Record<string, string> = {
  ...
  'Amplify': 'Educators using Amplify curricula are building AI tools that extend and personalize their existing materials. You\'ll find lesson scaffolders, student practice companions, and formative assessment helpers shaped by Amplify\'s approach to literacy and science instruction.',
  'CA Community Colleges': 'Faculty and staff across California\'s community college system are building tools for adult learners navigating transfer pathways, career training, and developmental coursework. Apps range from advising assistants to study coaches designed for students balancing school with work and family.',
  'CIOB': 'Educators across the Consortium of International Outward Bound Schools are creating tools that blend experiential learning with academic rigor. You\'ll find expedition planning aids, reflection journals, and character development activities shaped by Outward Bound\'s philosophy of learning through challenge.',
  'Fairfax': 'Apps built by Fairfax County students, showcasing what young people create when given the tools to build for their own classrooms and communities. From homework helpers to peer tutoring bots, these apps reflect student voice and the problems students themselves want to solve.',
  'Ghana': 'Ghanaian educators are building tools grounded in their national curriculum, local languages, and the realities of their classrooms. You\'ll find apps supporting English language development, STEM exploration, exam preparation, and culturally relevant content that connects learning to students\' daily lives.',
  'KIPP': 'KIPP educators across the network are building tools that reflect their emphasis on high expectations, structured support, and college readiness. Apps include lesson planners aligned to school-wide goals, student practice tools with built-in scaffolding, and advisory resources for social-emotional learning.',
  'Leading Educators': 'Members of the Leading Educators community are building tools focused on instructional coaching, teacher development, and leadership practice. You\'ll find observation debrief helpers, PLC facilitators, feedback generators, and coaching conversation planners created by educators who lead from the classroom.',
  'NYC': 'New York City public school educators are building for one of the most diverse school systems in the world. Apps span multilingual support, culturally responsive lesson planning, Regents exam prep, and tools designed for the specific needs of NYC neighborhoods, from the Bronx to Brooklyn.',
  'Texas': 'Texas educators are building tools aligned to TEKS standards and shaped by the diversity of their state, from rural districts to major metros. You\'ll find STAAR test prep, bilingual education resources, CTE pathway tools, and lesson planners reflecting the breadth of Texas classrooms.',
};

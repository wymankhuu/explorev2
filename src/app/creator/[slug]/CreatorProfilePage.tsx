...
import { ArrowLeft, Shuffle, Star, Users } from 'lucide-react';
import type { App } from '@/lib/types';
import { getInitials, formatNumber, generateCollectionId } from '@/lib/utils';
...
export default function CreatorProfilePage({ creator, role, apps }: CreatorProfilePageProps) {
    ...
    <div className="min-h-screen pb-20">
      <div className="max-w-5xl mx-auto px-6 pt-6">
        ...
        <div className="flex items-start gap-5 mb-8">
          <div className="w-16 h-16 rounded-full flex items-center justify-center bg-primary text-white text-xl font-bold shrink-0">
            {initials}
          </div>
          <div>
